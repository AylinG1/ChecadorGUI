...
public class PrincipalSupervisor extends JFrame {
    ...
    public void cargarReporte(){
        // Ahora, inicializa el JCalendar y lo añades al panel.
    }
    ...
    private void initComponents() {
		...
		//======== panel4 ========
		{
			...
			( )) ); panel4. addPropertyChangeListener (new java. beans. PropertyChangeListener( ){  public void propertyChange (java
			...
			//======== panelInicio ========
			{
				...
				//======== panelAlertas ========
				{
					...
					fechaact.setFont(new Font("Dialog", Font.BOLD, 14));
